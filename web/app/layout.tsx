...
export const metadata: Metadata = {
  ...
  description: "Niezależna platforma prognozująca poparcie partii politycznych w Polsce oraz interaktywny symulator wpływu stóp NBP i inflacji. Model statystyczny: AI (beta).",
  keywords: [
    "wybory",
    "sondaże",
    "prognoza wyborcza",
  ...
  twitter: {
    ...
    description: "Model statystyczny AI (beta) badający sondaże, trendy i gospodarkę.",
    creator: "@takzendev",
  ...
  "@graph": [
    {
      ...
      "operatingSystem": "All",
      "description": "Niezależna platforma prognozująca poparcie partii politycznych w Polsce oraz symulator gospodarczy oparty o model AI (beta).",
      "author": {
        "@type": "Organization",
        "name": "TAKZEN DEV",
