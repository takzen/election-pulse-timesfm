...
HISTORICAL_ANCHORS = [
    ...
    # August - September 2026 Latest Real Polls (United Surveys WP, IBRiS Onet, Pollster SE, Opinia24)
    ...
    ("2026-09-09", "Opinia24", 1001, 31.40, 17.50, 12.60, 6.90, 7.20, 5.70, 4.20, 2.20, 1.40, 10.90),
]
